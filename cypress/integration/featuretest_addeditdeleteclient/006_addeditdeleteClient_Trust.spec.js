...
describe('Add New Client - Trust.', () => {
    ...
    before(function () {
        ...
        cy.fixture('userlogin-trialloop.json').then((userlogin) => {
              ...
              cy.fixture('newClientTrust1.json').then((client) => {
                // "this" is still the test context object
                this.client = client;
                newClient = this.client;
                newClient.clientRef = randomUser.clientref;
                newClient.businessName = randomUser.firstName;
    ...
    it('Login HTC and add New Client - Trust.', () => {

      
        //Add a new Trust Client
        commonFunctions.addNewClient_Trust_General(newClient.clientType, newClient.businessName, newClient.alternativeName, newClient.dateIncorporated, newClient.website, newClient.clientRef);
