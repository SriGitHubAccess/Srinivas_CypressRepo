...
describe('Add New Client - Partnership.', () => {
    ...
    before(function () {
        ...
        cy.fixture('userlogin-trialloop.json').then((userlogin) => {
            ...
            cy.fixture('newClientPartnership1.json').then((client) => {
                // "this" is still the test context object
                this.client = client;
    ...
    it('Login HTC and add New Client - Partnership.', () => {

        //Add a new Partnership Client 
        commonFunctions.addNewClient_Pertnership_General(newClient.clientType, newClient.businessName, newClient.alternativeName, newClient.dateIncorporated, newClient.website, newClient.clientRef);
    ...
    it('Edit Client - Partnership Type.', () => {
    ...
    it('Delete Client - Partnership Type.', () => {
