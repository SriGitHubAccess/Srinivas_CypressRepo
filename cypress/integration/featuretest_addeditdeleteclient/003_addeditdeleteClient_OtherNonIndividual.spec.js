...
describe('Add New Client - Other Non Individual.', () => {
    ...
    before(function () {
        ...
        cy.fixture('userlogin-trialloop.json').then((userlogin) => {
              ...
              cy.fixture('newClientOtherNonIndividual1.json').then((client) => {
                // "this" is still the test context object
                this.client = client;
                newClient = this.client;
                newClient.clientRef = randomUser.clientref;
                newClient.businessName = Client_name;
                newClient.alternativeName = randomUser.lastName;
    ...
    it('Login HTC and add New Client - Other Non Individual.', () => {

     
        //Add a new Other Non Individual Client
        commonFunctions.addNewClient_OtherNonIndividual_General(newClient.clientType, newClient.businessName, newClient.alternativeName, newClient.dateIncorporated, newClient.website, newClient.clientRef);
    ...
    it('Edit Client - Other Individual Type.', () => {
    ...
    it('Delete Client - Other Individual Type.', () => {
