...
describe('Add New Client - SMSF.', () => {
    ...
    before(function () {
        ...
        cy.fixture('userlogin-trialloop.json').then((userlogin) => {
              ...
              cy.fixture('newClientSMSF1.json').then((client) => {
                // "this" is still the test context object
                this.client = client;
    ...
    it('Login HTC and add New Client - SMSF.', () => {

     
        //Add a new SMSF Client
        commonFunctions.addNewClient_SMSF_General(newClient.clientType, newClient.businessName, newClient.alternativeName, newClient.dateIncorporated, newClient.website, newClient.clientRef);
