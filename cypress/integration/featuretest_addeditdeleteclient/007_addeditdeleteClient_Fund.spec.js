...
describe('Add New Client - Fund.', () => {
    ...
    before(function () {
        ...
        cy.fixture('userlogin-trialloop.json').then((userlogin) => {
              ...
              cy.fixture('newClientFund1.json').then((client) => {
                // "this" is still the test context object
                this.client = client;
    ...
    it('Login HTC and add New Client - Fund.', () => {

      
        //Add a new Fund Client
        commonFunctions.addNewClient_Fund_General(newClient.clientType, newClient.businessName, newClient.alternativeName, newClient.dateIncorporated, newClient.website, newClient.clientRef);
