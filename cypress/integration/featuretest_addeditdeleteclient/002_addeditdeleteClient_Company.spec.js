...
describe('Add New Client - Company', () => {
    ...
    before(function () {
        ...
        //  Cypress.env("FAILED_PREV_TEST",false);
              ...
              cy.fixture('newClientCompany1.json').then((client) => {
                // "this" is still the test context object
                this.client = client;
    ...
    it('Login HTC and add New Client - Company Type.', () => {

        //Launch HTC QA
       
        //Add a new Company Client 
        commonFunctions.addNewClient_Company_General(newClient.clientType, newClient.businessName, newClient.alternativeName, newClient.dateIncorporated, newClient.website, newClient.clientRef);
