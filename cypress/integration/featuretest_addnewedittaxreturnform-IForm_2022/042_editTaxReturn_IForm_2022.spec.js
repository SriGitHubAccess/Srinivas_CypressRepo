...
describe.skip('Add Tax Form - IForm', () => {
    ...
    before(function () {
        ...
        cy.fixture('userlogin-trialloop.json').then((userlogin) => {
              ...
              cy.fixture('newTaxFormIndividual1.json').then((testData) => {
                // "this" is still the test context object
    ...
    it('Add New Tax Form - IForm 2021 to 2022', () => {
        ...
        //Add New Tax Form
        commonFunctions.addNewTaxForm2122(newTaxFormData.clientRef, newTaxFormData.formType, newTaxFormData.agent);
