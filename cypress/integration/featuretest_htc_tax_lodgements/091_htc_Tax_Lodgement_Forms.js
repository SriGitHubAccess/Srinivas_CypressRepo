...
describe('Add Tax Form - Fund', () => {
    ...
    before(function () {
        ...
        cy.fixture('userlogin-trialloop.json').then((userlogin) => {
              ...
              cy.fixture('newTaxFormFund1.json').then((testData) => {
                // "this" is still the test context object
    ...
    it('Add New Tax Form - Fund FBT', () => {
        ...
        commonFunctions.lodgeTaxReturn(newTaxReturnIFormData.individualIncome[0].clientRef, 'I Form', '2022');
